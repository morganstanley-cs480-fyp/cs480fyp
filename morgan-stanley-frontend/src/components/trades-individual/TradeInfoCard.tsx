        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium text-slate-900">{trade.trade_id}</p>
            </div>
            <div>
              <p className="text-sm text-slate-600 mb-1">Account</p>
              <p className="font-medium text-slate-900">{trade.account}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium text-slate-900">{trade.asset_type}</p>
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-slate-600 mb-1">Booking System</p>
              <p className="font-medium text-slate-900">{trade.booking_system}</p>
            </div>
            <div>
              <p className="text-sm text-slate-600 mb-1">Affirmation System</p>
              <p className="font-medium text-slate-900">{trade.affirmation_system}</p>
            </div>
            <div>
              <p className="text-sm text-slate-600 mb-1">Clearing House</p>
              <p className="font-medium text-slate-900">{trade.clearing_house}</p>
            </div>
          </div>
