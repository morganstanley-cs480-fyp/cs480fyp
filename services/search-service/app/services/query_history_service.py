...
class QueryHistoryService:
    ...
    async def save_query(self, user_id: str, query_text: str, search_type: str) -> int:
        """
    ...
    async def delete_query(self, query_id: int, user_id: str) -> None:
        """
    ...
    async def delete_all_user_queries(self, user_id: str) -> int:
        """
    ...
    async def update_last_use_time(self, query_id: int, user_id: str) -> None:
        """
