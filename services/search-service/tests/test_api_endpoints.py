...
class TestHealthEndpoints:
    ...
    async def test_health_check_all_healthy(self, client):
        ...
        with patch('app.api.routes.health.db_manager.health_check', new_callable=AsyncMock) as mock_db, \
             patch('app.api.routes.health.redis_manager.health_check', new_callable=AsyncMock) as mock_redis:
...
class TestHistoryEndpoints:
    ...
    async def test_delete_history_unauthorized(self, client):
        ...
        with patch('app.services.query_history_service.query_history_service.delete_query',
